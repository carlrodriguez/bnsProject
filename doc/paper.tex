...
approximation to be valid.  By selecting a source population with an
 artificial distribution in SNR, we ensure that the
     ``zero-noise'' as average uncertainty approximation is valid.
       This approach has been employed in previous studies to similar effect
        (e.g. \cite{Nissanke2010} and \cite{Sampson2013}).
...
a particular simulated signal to perform parameter estimation upon in
